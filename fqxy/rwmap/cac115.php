...
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>昏迷的少女</p></a>"."<br>";
}
...
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>你和晓月离开后</p></a>"."<br>";
}
