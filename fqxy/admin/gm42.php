<?php
echo "<p style='color: red'>【发放成功通知】（全服）</p>" . "<br>";
$czid = $wpid;
$ppwpsl = $wpsl;
...
echo "<p style='color: red'>【发放完毕】（全服）</p>" . "<br>";
echo "<br>";
echo "<a href='gm.php?wjid=$wjiddd&&pass=$password&&gid=40&&user=$wjid'><p style='color: blue'>返回继续发放</p></a>" . "<br>";
echo "<br>";
