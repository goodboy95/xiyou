...
if ($rid == 101) {
    ...
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>（小二突然一掌向后拍出，将黑衣人击倒在地上）</p>" . "<br>";
    echo "<p style='color: black'>店小二∶谁是小伙计呀！你们这几个不长眼睛的混蛋先给我打听清楚我是何许人物？竟敢在我的店里撒野？要闹事就给我滚到别处去，小心我拆了你们的骨头拿去熬汤！
</p>" . "<br>";
} elseif ($rid == 106) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    ...
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶真是不自量力！想当年我也是普陀大弟子出生</p>" . "<br>";
} elseif ($rid == 108) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶这种三脚猫货色我才不放在眼里，想当年我．．算了．．不提了。喂～你高兴个什么劲！闹出人命啦！这下怎么收拾？</p>" . "<br>";
} elseif ($rid == 109) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：这班西域匪杀人越货、强掳弱女死有余辜！你这是替天行道！</p>" . "<br>";
    echo "<p style='color: black'>店小二∶去你的．．就会说风凉话，日后官差问起来总是件麻烦事</p>" . "<br>";
} elseif ($rid == 110) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：那．．这位小姑娘怎么办？她师父遇难了，孤苦伶仃一个人～咱们总不能不管吧？</p>" . "<br>";
    echo "<p style='color: black'>店小二∶唉～造孽．．．那就让她在这里住下来吧</p>" . "<br>";
} elseif ($rid == 111) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶你去楼上挑一间比较安静的房间，让她好好休息一下。人家遇到这种惨事，心里一定很难过。你可要多多关照人家别让她想不开呀！</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：放心．．我知道。</p>" . "<br>";
} elseif ($rid == 112) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>（你将清清领到楼上安顿好，清清很快就睡着了．．）</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：唉．．看来她真的是累坏了．</p>" . "<br>";
} elseif ($rid == 113) {
    echo "<p style='color: black'>【去南城客栈睡房休息】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶小姑娘还好吧？</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：倒头便睡着了。看来．．她一夜都未曾合过眼。</p>" . "<br>";
    echo "<p style='color: black'>店小二∶好吧．．这里没你的事了，回睡房休息去吧．．</p>" . "<br>";
} elseif ($rid == 114) {
    ...
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶你欺负人家啦？</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：我哪敢啊！？</p>" . "<br>";
    echo "<p style='color: black'>店小二∶你这浑小子！半夜三更让人家一个女孩子在外面哭鼻子～还说不是欺负人家？</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：我～我～</p>" . "<br>";
} elseif ($rid == 119) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>（这晚你只好和清清一起睡，一夜过去）次日．．店小二∶呵～呵～你这小子！</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：小二．．干嘛笑得那么诡异？</p>" . "<br>";
    echo "<p style='color: black'>店小二∶少跟我装傻！你小子艳福不浅呀！</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：．．．．．．</p>" . "<br>";
} elseif ($rid == 120) {
    echo "<p style='color: black'>【南城客栈和店小二说话】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶我决定了！！就让你带清清去西域找妈妈～</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：她都告诉你啦？</p>" . "<br>";
    echo "<p style='color: black'>店小二∶嘿～从小到大．．你有哪件事瞒得过你小二哥的？</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：到西域可是数千里之远喔！我要是去了，这一趟可不只是十天半个月的哦！</p>" . "<br>";
} elseif ($rid == 121) {
    echo "<p style='color: black'>【南城客栈和清清说话】</p>" . "<br>";
    echo "<p style='color: black'>店小二∶你这么大了。再说．．你这个性．．也不可能在这客栈待得下去。年青人出去见见世面也未尝不好。</p>" . "<br>";
    echo "<p style='color: black'>$name</p>" . "<p style='color: black'>：小二大哥～您终于了解我了！</p>" . "<br>";
} elseif ($rid == 122) {
    echo "<p style='color: black'>【南城客栈和清清说话】</p>" . "<br>";
    ...
    echo "<p style='color: black'>【歪柳巷萧晓月】</p>" . "<br>";
    echo "<p style='color: black'>萧晓月∶慢着！死罪可免，活罪难逃！各砍断一只手，作为警惕！</p>" . "<br>";
} elseif ($rid == 141) {
    echo "<p style='color: black'>【歪柳巷和萧晓月说话】</p>" . "<br>";
    ...
    echo "<p style='color: black'>【去城隍庙和萧晓月说话】</p>" . "<br>";
    echo "<p style='color: black'>流氓：敢坏大爷好事！小子～你也想尝鲜呀？</p>" . "<br>";
} elseif ($rid == 157) {
    echo "<p style='color: black'>【城隍庙和萧晓月说话】</p>" . "<br>";
    ...
    echo "<p style='color: black'>【白虎大街和被打的书生说话】</p>" . "<br>";
    echo "<p style='color: black'>众酒客：少管闲事～要不连你一块打！</p>" . "<br>";
} elseif ($rid == 177) {
