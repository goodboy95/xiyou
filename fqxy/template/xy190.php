...
echo "<p style='color: black'>['攻城-信息']</p>"."<br>";
echo "<p style='color: black'>编号/位置/占领方</p>"."<br>";
echo "<p style='color: black'>1.傲来国|（".$zlf1."占领）</p>"."<br>";
echo "<p style='color: black'>2.宝象国|（".$zlf2."占领）</p>"."<br>";
echo "<p style='color: black'>3.乌鸡国|（".$zlf3."占领）</p>"."<br>";
echo "<p style='color: black'>4.女儿国|（".$zlf4."占领）</p>"."<br>";
echo "<p style='color: black'>5.车迟国|（".$zlf5."占领）</p>"."<br>";
echo "<p style='color: black'>6.祭赛国|（".$zlf7."占领）</p>"."<br>";
echo "<p style='color: black'>战场位置：".$zcwz."</p>"."<br>";
echo "<p style='color: black'>开放时间：".$kfsj."</p>"."<br>";
echo "<p style='color: black'>开放等级：60级以上</p>"."<br>";
echo "<p style='color: black'>占领国家：".$zlgj."(".$gjjz.")</p>"."<br>";
echo "<br>";
