...
echo "<p style='color: black'>至尊皇族</p>"."<br>";
...
echo "<p style='color: red'>剩余:".$hdcs."次（每天/次）</p>"."<br>";
echo "<br>";
echo "<p style='color: red'>【至尊皇族】-</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=302;
...
echo "<p style='color: red'>亲！【至尊皇族】已到期，或者未开通（在游戏左下角充值100元联系GM并告知开通月卡）</p><br>";

}

echo "<br>";

echo "<p style='color: black'>介绍：玩家开通【至尊皇族】后每日领取〖金豆〗x30，〖至尊皇族宝箱〗x1</p><br>";
echo "<p style='color: black'>【至尊皇族】100元/30次（单购,不计算vip积分）</p><br>";
echo "<p style='color: black'>〖至尊皇族宝箱〗（随机必得三四五级石头x30，随机必得各类区域门派声望卷x3，随机银两1000万-1亿）</p><br>";
echo "<p style='color: black'>注：各类贵族可以一起开通奖励更丰厚</p><br>";
