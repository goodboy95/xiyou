...
$clj[]=371;
$npc[]=$npcc;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>我心意已决</p></a>"."<br>";
...
$clj[]=365;
$npc[]=$npcc;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>哦！我点错了</p></a>"."<br>";
