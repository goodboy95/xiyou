...
//判断ini文件是否存在	
                $ininame = $path . "/" . $inina;
                unlink($ininame); //删除文件  
                echo "<p style='color: black'>恭喜你！成功将" . $cw01x . "提升至了极品" . $cw03x . "星</p>" . "<br>";
                ...
                echo "<p style='color: black'>对不起！升星失败需要" . $cwxf03 . "x" . $cwxf02 . "</p>" . "<br>";
            }
        } else {
            echo "<p style='color: black'>阁下的" . $cwmz2 . "已经是极品满星了（不需要升星了）</p>" . "<br>";
        }
//cmd及超链接值
        $cmid = $cmid + 1;
        $cdid[] = $cmid;
