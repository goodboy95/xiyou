            ...
            if ($minute <= $jy03) {
                ...
                if ($minute > 0) {
                    ...
                    if ($minute10 > 0) {
                        ...
                        if ($minute9 > 0) {
                            $second = $minute10 % 24;
                            echo "<p style='color: red'>由于你在游戏内发布不正当言论已被GM禁言！！</p>" . "<br>";
                            echo "<p style='color: red'>剩余：" . $minute9 . "天" . $second . "小时后可正常发言</p>" . "<br>";
                        } else {
                            $second = $minute % 60;
                            echo "<p style='color: red'>由于你在游戏内发布不正当言论已被GM禁言！！</p>" . "<br>";
                            echo "<p style='color: red'>剩余：" . $minute10 . "时" . $second . "分后可正常发言</p>" . "<br>";
                        }
                    } else {
                        echo "<p style='color: red'>由于你在游戏内发布不正当言论已被GM禁言！！</p>" . "<br>";
                        echo "<p style='color: red'>剩余：" . $minute . "分" . $second . "秒后可正常发言</p>" . "<br>";
                    }
                } else {
                    echo "<p style='color: red'>由于你在游戏内发布不正当言论已被GM禁言！！</p>" . "<br>";
                    echo "<p style='color: red'>剩余：" . $second . "秒后可正常发言</p>" . "<br>";
                }
            } else {
                $jybl = 1;
            }
...
# 获取一个分类下所有数据
                        ...
                        echo "<p style='color: red'>长度不能超过50个字符</p><br>";
                    }
                } else {
        ...
        echo "<p style='color: red'>由于你在游戏内发布不正当言论已被GM永久禁言！！</p>" . "<br>";
    }
    $inina = "ltymid.ini";
    $path = 'ache/' . $wjid;
//判断ini文件是否存在	
...
//cmd及超链接值
    ...
    if ($m >= 1) {
        ...
        for ($b = 0; $b < 10; $b++) {
            ...
            echo "<p style='color: black'>['公共']</p></a>";
...
//cmd及超链接值
            ...
            echo "<p style='color: black'>：" . $pxwjtake[$i] . "</p><br>";
            $ltmax = $ltmax - 1;
        }
    } else {
        echo "<br>";
        echo "<p style='color: red'>小轩Say：这个世界还很清静！！</p><br>";
        echo "<br>";
