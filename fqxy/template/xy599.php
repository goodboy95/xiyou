...
if($bpdj>=5){
echo "<p style='color: red'>【五级国家商城】</p>"."<br>";
...
$clj[]=605;
$npc[]=19;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>兑换（500贡献+10亿银两）</p></a>"."<br>";
...
$clj[]=606;
$npc[]=307;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>大幸运草</p></a>";
echo "<p style='color: black'>|</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
...
echo "<p style='color: black'>五国家商城未开启（升级国家后开启）</p>"."<br>";
} 
