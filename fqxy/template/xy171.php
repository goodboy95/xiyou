...
echo "<p style='color: red'>你输入的国家名包含敏感字符请重新输入</p>"."<br>";
}
} else{


echo "<p style='color: red'>国家名长度不能超过限制</p><br>";
...
echo "<p style='color: red'>国家名不能为空</p><br>";
...
echo "<p style='color: black'>请输入你要建立的国家名字</p>"."<br>";
