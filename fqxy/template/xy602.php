...
if($bpdj>=8){
echo "<p style='color: red'>【八级国家商城】</p>"."<br>";
...
$clj[]=606;
$npc[]=427;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>〖1万西游声望卷轴〗</p></a>";
echo "<p style='color: black'>|</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=27;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>兑换（200贡献+5亿银两）</p></a>"."<br>";
...
$clj[]=606;
$npc[]=454;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>〖双倍掉宝符〗</p></a>";
echo "<p style='color: black'>|</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=28;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>兑换（1000贡献+10亿银两）</p></a>"."<br>";
...
$clj[]=606;
$npc[]=494;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>〖荣誉宝石包〗（2个）</p></a>";
echo "<p style='color: black'>|</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
...
echo "<p style='color: black'>八国家商城未开启（升级国家后开启）</p>"."<br>";
} 
