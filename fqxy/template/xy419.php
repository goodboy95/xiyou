...
echo "<p style='color: black'>钻石皇族|</p>";
...
echo "<p style='color: red'>亲！【钻石皇族】已到期，或者未开通（在游戏左下角充值50元联系GM并告知开通月卡）</p><br>";
...
echo "<p style='color: black'>介绍：玩家开通【钻石皇族】后每日领取〖金豆〗x15，〖钻石皇族宝箱〗x1</p><br>";
echo "<p style='color: black'>【钻石皇族】50元/30次（单购,不计算vip积分）</p><br>";
echo "<p style='color: black'>〖钻石皇族宝箱〗（随机必得三四五级石头x15，随机必得各类区域门派声望卷x1，随机银两500万-3000万）</p><br>";
