...
//不走xy.php直接调用xy文件需要加pz01配置
                        ...
                        echo "<p style='color: red'>这个名字太火爆了换一个吧！！</p>" . "<br>";
                    }
                } else {
    ...
    if ($npcc == 1) {
        echo "<p style='color: black'>你取个霸气威武的名字吧</p><br>";
        echo "<p style='color: black'>你选择了男性</p><br>";
        include("./sql/mysql.php");//调用数据库连接 
        $q2 = "all_zt";
...
# 修改一个分类下子项的值(也可以修改多个)
        ...
        echo "<p style='color: black'>你取个霸气威武的名字吧</p><br>";
        echo "<p style='color: black'>你选择了女性</p><br>";
        include("./sql/mysql.php");//调用数据库连接 
        $q2 = "all_zt";
        $strsql = "update $q2 set sex=1 where wjid=$wjid";//物品id号必改值
        $result = mysqli_query($conn, $strsql);
...
# 修改一个分类下子项的值(也可以修改多个)
        ...
        if ($jcxb == 1) {
            echo "<p style='color: black'>请取个霸气威武的名字吧</p><br>";
            echo "<p style='color: black'>你选择了男性</p><br>";
        } else {
            echo "<p style='color: black'>请取个霸气威武的名字吧</p><br>";
            echo "<p style='color: black'>你选择了女性</p><br>";
