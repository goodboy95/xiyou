...
////////////////////////////////缓存更新///////////////////////
	...
	echo "<p style='color: red'>恭喜你取出了银两：</p>";
	$yl=$sl;
	$clor="red";
		include("./wp/sxf.php");
...
echo "<p style='color: red'>对不起!你仓库没有那么多银两哦!</p>"."<br>";

}
} else {

echo "<p style='color: red'>对不起!你本次取款达到了背包银两上限!请重新输入</p>"."<br>";
...
echo"<p style='color: black'>请输入取出的银两：</p></a>";
?>
...
$clj[]=257;
$npc[]=0;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>放弃取款</p></a>"."<br>";
