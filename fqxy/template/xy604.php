...
if($bpdj>=10){
echo "<p style='color: red'>【十级国家商城】</p>"."<br>";
...
$clj[]=606;
$npc[]=626;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>〖5亿修炼经验丹〗</p></a>";
echo "<p style='color: black'>|</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=33;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>兑换（3000贡献+3亿银两）</p></a>"."<br>";
...
$clj[]=606;
$npc[]=627;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>〖10亿修炼经验丹〗</p></a>";
echo "<p style='color: black'>|</p>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=627;
$npc[]=34;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>兑换（6000贡献+6亿银两）</p></a>"."<br>";
...
$clj[]=627;
$npc[]=35;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><p style='color: blue'>兑换（1000贡献+1亿银两）</p></a>"."<br>";
...
echo "<p style='color: black'>十国家商城未开启（升级国家后开启）</p>"."<br>";
} 
